...
set rc [catch {
  ...
  d:/Xilinx_Proj_Mar/Digital_Clock/Digital_Clock.cache/ip
  d:/Xilinx_Proj_Mar/Digital_Clock/74LSXX_LIB
  D:/Xilinx_Proj_Mar/Digital_Clock/Interface
} [current_project]
  set_property ip_output_repo d:/Xilinx_Proj_Mar/Digital_Clock/Digital_Clock.cache/ip [current_project]
  add_files -quiet D:/Xilinx_Proj_Mar/Digital_Clock/Digital_Clock.runs/synth_1/design_1_wrapper.dcp
  read_xdc -prop_thru_buffers -ref design_1_clk_wiz_0_1 -cells inst d:/Xilinx_Proj_Mar/Digital_Clock/Digital_Clock.srcs/sources_1/bd/design_1/ip/design_1_clk_wiz_0_1/design_1_clk_wiz_0_1_board.xdc
  set_property processing_order EARLY [get_files d:/Xilinx_Proj_Mar/Digital_Clock/Digital_Clock.srcs/sources_1/bd/design_1/ip/design_1_clk_wiz_0_1/design_1_clk_wiz_0_1_board.xdc]
  read_xdc -ref design_1_clk_wiz_0_1 -cells inst d:/Xilinx_Proj_Mar/Digital_Clock/Digital_Clock.srcs/sources_1/bd/design_1/ip/design_1_clk_wiz_0_1/design_1_clk_wiz_0_1.xdc
  set_property processing_order EARLY [get_files d:/Xilinx_Proj_Mar/Digital_Clock/Digital_Clock.srcs/sources_1/bd/design_1/ip/design_1_clk_wiz_0_1/design_1_clk_wiz_0_1.xdc]
...
set rc [catch {
  ...
  if { [file exists D:/Xilinx_Proj_Mar/Digital_Clock/Digital_Clock.runs/synth_1/design_1_wrapper.hwdef] } {
    catch { write_sysdef -hwdef D:/Xilinx_Proj_Mar/Digital_Clock/Digital_Clock.runs/synth_1/design_1_wrapper.hwdef -bitfile design_1_wrapper.bit -meminfo design_1_wrapper.mmi -file design_1_wrapper.sysdef }
  }
