...
<%
	...
	if(rs.next())
	{
		...
		byte[] certBytes=rs.getBytes("pvk");
  


		if(certType==0) 
			fname="pkiUser_Pvk_certId("+certId+")_applyId("+applyId+")_forSign&Verify.pem";
		else
			fname="pkiUser_Pvk_certId("+certId+")_applyId("+applyId+")_forEncrypt&Decrypt.pem";
