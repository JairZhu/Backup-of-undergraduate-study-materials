...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="32%" nowrap height="17"><font size="2">1.输入查询条件，点击[查询]</font></td>
  </tr>
  <tr> 
    <td width="68%" nowrap height="17">&nbsp;</td>
    <td width="32%" nowrap height="17"><font size="2">2.点击所列出证书的序列号可以下载该证书！</font></td>
  </tr>
  <tr> 
    <td rowspan="2" nowrap height="34"> 
    ...
    <td width="32%" height="17"><font size="2">3.点击所列出证书后面的[检查]可以检查该证书是否已被撤消</font></td>
  </tr>
  <tr> 
    <td height="17"><font size="2">4.点击所列出证书后面的[下载]可下载该证书对应的私钥（该功能只限于用于加解密的证书）。</font></td>
  </tr>
</table>
<table border="1" cellspacing="0" cellpadding="0" bordercolor="#999999">
  <tr> 
	...
	<td  nowrap> 
      <div align="center"><font size="2" color="#0000FF">下载私钥</font></div>
    </td>
  </tr>
<%
...
%>
  ...
  <tr> 
    ...
    <td  align=center nowrap height="2"><font size="2"><a href="checkcrl.jsp?certId=<%=certId%>">检查</a></font></td>
     <td  align=center nowrap height="2"><font size="2">
<%
				if(certType==1){
%>
	 <a href="downpvk.jsp?certId=<%=certId%>">下载</a>
<%
				}
				else
				{
