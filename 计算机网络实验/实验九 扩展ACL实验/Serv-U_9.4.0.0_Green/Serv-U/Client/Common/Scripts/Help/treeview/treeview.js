...
YAHOO.extend(YAHOO.widget.TextNode, YAHOO.widget.Node, {
    ...
    getNodeHtml: function() { 
        ...
        if (this.hasChildren(true)) {
            sb[sb.length] = ' onmouseover="javascript:this.className=';
            sb[sb.length] = getNode + '.getHoverStyle()"';
            sb[sb.length] = ' onmouseout="javascript:this.className=';
        ...
        */
        ...
        sb[sb.length] = ' onclick="javascript:return ' + getNode + '.onLabelClick(' + getNode +')"';
        if (this.hasChildren(true)) {
            sb[sb.length] = ' onmouseover="javascript:document.getElementById(\'';
            sb[sb.length] = this.getToggleElId() + '\').className=';
            sb[sb.length] = getNode + '.getHoverStyle()"';
            sb[sb.length] = ' onmouseout="javascript:document.getElementById(\'';
            sb[sb.length] = this.getToggleElId() + '\').className=';
            sb[sb.length] = getNode + '.getStyle()"';
        }
        sb[sb.length] = ' >';
