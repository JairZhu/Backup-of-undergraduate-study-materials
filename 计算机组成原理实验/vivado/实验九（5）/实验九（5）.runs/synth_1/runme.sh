...
HD_PWD='C:/Users/73974/Documents/vivado/实验九（5）/实验九（5）.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sy9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sy9.tcl
