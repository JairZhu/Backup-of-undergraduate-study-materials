...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ALU_0_result [get_bd_pins ALU_0/result] [get_bd_pins control_unit_0/q]
  connect_bd_net -net A_1 [get_bd_ports A] [get_bd_pins ALU_0/A]
  connect_bd_net -net B_1 [get_bd_ports B] [get_bd_pins ALU_0/B]
  connect_bd_net -net control_unit_0_r [get_bd_ports r] [get_bd_pins control_unit_0/r]
