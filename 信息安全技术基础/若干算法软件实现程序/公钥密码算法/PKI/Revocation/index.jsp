...
<h3 align=center>撤消证书</h3>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td height="2" width="70%">这里列出了未被撤消的证书: </td>
  ...
  <tr> 
    ...
    <td width="30%" nowrap><font size="2">2.点击证书后的[撤消]可以撤消该证书！</font></td>
  </tr>
</table>
<table border="1" cellspacing="0" cellpadding="0" bordercolor="#999999">
  <tr> 
    ...
    <td  nowrap> 
      <div align="center"><font size="2" color="#0000FF">撤消否</font></div>
    </td>
  </tr>
<%
	...
	String  sqlstr="select * from CertBrowserView_NotRevocated ";
...
%>
  ...
  <tr> 
    ...
    <td  align=center nowrap height="2"><font size="2"><a href="reason.jsp?certId=<%=certId%>">撤消</a></font></td>
  </tr>
