...
set rc [catch {
  ...
  d:/Xilinx_Proj_Mar/B3_Lab/Lab4/MIPS_CPU/src/prj/MIPS_CPU.cache/ip
  d:/Xilinx_Proj_Mar/B3_Lab/Lab4/MIPS_CPU/src/IPCatalog
} [current_project]
  set_property ip_output_repo d:/Xilinx_Proj_Mar/B3_Lab/Lab4/MIPS_CPU/src/prj/MIPS_CPU.cache/ip [current_project]
  add_files -quiet d:/Xilinx_Proj_Mar/B3_Lab/Lab4/MIPS_CPU/src/prj/MIPS_CPU.runs/synth_1/MIPS_CPU_wrapper.dcp
  read_xdc -prop_thru_buffers -ref MIPS_CPU_clk_wiz_0_0 -cells inst d:/Xilinx_Proj_Mar/B3_Lab/Lab4/MIPS_CPU/src/prj/MIPS_CPU.srcs/sources_1/bd/MIPS_CPU/ip/MIPS_CPU_clk_wiz_0_0/MIPS_CPU_clk_wiz_0_0_board.xdc
  set_property processing_order EARLY [get_files d:/Xilinx_Proj_Mar/B3_Lab/Lab4/MIPS_CPU/src/prj/MIPS_CPU.srcs/sources_1/bd/MIPS_CPU/ip/MIPS_CPU_clk_wiz_0_0/MIPS_CPU_clk_wiz_0_0_board.xdc]
  read_xdc -ref MIPS_CPU_clk_wiz_0_0 -cells inst d:/Xilinx_Proj_Mar/B3_Lab/Lab4/MIPS_CPU/src/prj/MIPS_CPU.srcs/sources_1/bd/MIPS_CPU/ip/MIPS_CPU_clk_wiz_0_0/MIPS_CPU_clk_wiz_0_0.xdc
  set_property processing_order EARLY [get_files d:/Xilinx_Proj_Mar/B3_Lab/Lab4/MIPS_CPU/src/prj/MIPS_CPU.srcs/sources_1/bd/MIPS_CPU/ip/MIPS_CPU_clk_wiz_0_0/MIPS_CPU_clk_wiz_0_0.xdc]
...
set rc [catch {
  ...
  if { [file exists d:/Xilinx_Proj_Mar/B3_Lab/Lab4/MIPS_CPU/src/prj/MIPS_CPU.runs/synth_1/MIPS_CPU_wrapper.hwdef] } {
    catch { write_sysdef -hwdef d:/Xilinx_Proj_Mar/B3_Lab/Lab4/MIPS_CPU/src/prj/MIPS_CPU.runs/synth_1/MIPS_CPU_wrapper.hwdef -bitfile MIPS_CPU_wrapper.bit -meminfo MIPS_CPU_wrapper.mmi -file MIPS_CPU_wrapper.sysdef }
  }
