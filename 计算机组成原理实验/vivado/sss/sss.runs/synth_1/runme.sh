...
HD_PWD='C:/Users/73974/Documents/vivado/sss/sss.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sss.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sss.tcl
